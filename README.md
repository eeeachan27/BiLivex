...
<details>
<summary><b>v1.1.0</b>（2026-09-01）：新增弹幕收藏夹，收藏内容长效保存，悬浮窗拖动更跟手</summary>

- **v1.1.0**（2026-09-01）：
  - 新增弹幕收藏夹：从聊天区或漂浮弹幕一键收藏常用弹幕，支持搜索、编辑、删除、导入导出，一键填入或发送
  - 修复收藏弹幕后收起主菜单、收藏内容消失的问题，收藏数据长效保存
  - 修复悬浮窗拖动松软不跟手的问题，拖动过程实时跟随鼠标
</details>

<details>
<summary><b>旧版本</b>：v1.0.11 及更早版本</summary>
