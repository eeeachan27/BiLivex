...
- **自动检查更新**：每 6 小时自动检测一次新版本，发现更新时在悬浮球旁弹出提示；点击「忽略」不再提示该版本，点击「更新」在新标签页打开油猴更新页完成升级
...
<details>
<summary><b>v1.1.2</b>（2026-09-03）：修复网页全屏下屏幕边缘区域弹幕的操作栏无法显示/被遮挡，以及悬停弹幕透明度不一致问题</summary>
